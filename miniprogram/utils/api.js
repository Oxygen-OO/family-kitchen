...
const api = {
  ...
  listMembers: (familyId) => call('listMembers', { familyId }),
  leaveFamily: (familyId) => call('leaveFamily', { familyId }),
  transferOwnership: (familyId, toOpenid) => call('transferOwnership', { familyId, toOpenid }),
